...
LOCATION=me-west1
IMAGE=chat-node-envoy
TAG=0.0.1
TAG_LATEST=latest

# dir
SCRIPT_DIR=$(dirname "$(readlink -f "$0")")
DOCKERFILE_PATH=$SCRIPT_DIR/Dockerfile.prod
...
# IMAGE_TAG=me-west1-docker.pkg.dev/kyle-server-402706/kyle-registry/chat-node-envoy:0.0.1
